        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Congratulations Your registration for Basic Robotics is complete.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
             <center><b>Your Registration for Basic Robotics is successful. </b>
             <p><b>Please Complete Payment if you had not already</b> </p>
             <b>Shemonto - 01521487955</b></center>
